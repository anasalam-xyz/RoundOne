  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 w-full max-w-sm">
             ...
             type="button"                    // importantprevents form submit
              ...
              className={`px-6 py-2 rounded-[10px] text-xs font-semibold transition-all duration-200
                ${mode === m
                  ...
                  : "text-[#9090b0] hover:text-primary-medium"
                }`}
             >
      ...
      <div className="flex justify-center gap-3">
        ...
        >
          <svg width="18" height="18" viewBox="0 0 24 24" fill="#1a1a2e" aria-hidden="true">
      ...
      <button
        type="submit"
        disabled={loading}
        className="w-full bg-[#1a1a2e] hover:bg-primary-medium disabled:opacity-60
